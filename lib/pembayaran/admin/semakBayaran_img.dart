...
class SemakIMG extends ConsumerStatefulWidget {
  final fileURL;
  final userID;
  final docID;
  final pendDoc;
  SemakIMG({required this.fileURL,this.userID,this.docID,this.pendDoc});
  
  @override
  ConsumerState<SemakIMG> createState() => _SemakIMGState();
}
  

// 2. extend [ConsumerState]
class _SemakIMGState extends ConsumerState<SemakIMG> {
  String pathPDF = "";
  var dataBytes;
  ...
  Widget build(BuildContext context) {
    ...
    if (dataBytes != null) {
      child = Container(
        width: w,
        child: Image.memory(dataBytes,fit: BoxFit.fitWidth,));
    }
    return Scaffold(
